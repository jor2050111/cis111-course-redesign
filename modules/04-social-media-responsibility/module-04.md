# Module 4: Social Media Responsibility

In 2018, reports revealed that a political consulting firm had harvested personal data from tens of millions of Facebook users without their knowledge or consent. The data was not stolen through a hack. It was collected through a personality quiz app that also pulled data from every quiz-taker's friends list. Facebook's platform rules at the time allowed it. The result was a global reckoning about what social media companies owe their users, and what users give up when they click "I agree."

That story is not ancient history. Today, social media platforms collect more data than ever, algorithms decide what you see and what stays hidden, and employers routinely screen candidates' profiles before making hiring decisions. These platforms shape public opinion, influence elections, and create new forms of harassment that existing laws struggle to address. The ethical questions are not abstract. They affect your daily life, your career, and your rights.

This module examines social media through four lenses: platform ethics and data collection, content moderation and algorithmic bias, social media's role in hiring and cyberabuse, and the tension between user privacy and platform business models. You will apply the ethical frameworks from Part I to evaluate real scenarios and build your ability to reason through the layered responsibilities that social media creates for companies, users, and society.
...
Critics raise a different set of concerns. Targeted advertising can exploit vulnerabilities. For example, platforms have been caught allowing advertisers to target people experiencing emotional distress, financial difficulty, or addiction. When a gambling company can target users who recently searched for "debt relief," the line between relevant advertising and manipulation becomes thin.
...
2. A social media platform allows payday loan companies to target ads at users whose profiles suggest financial difficulty. Analyze this practice from both a utilitarian and a deontological perspective. *(Analyze)*
...
Both approaches have problems. Human moderators face enormous psychological strain from reviewing graphic and disturbing content for hours each day. Reports have documented high rates of burnout, anxiety, and post-traumatic stress among moderation workers, many of whom are contract employees in lower-wage countries with limited mental health support. From a virtue ethics perspective, the question is whether platforms are treating these workers as companies of good character should.
...
**The Situation:** StreamView is a popular video-sharing platform with 500 million monthly users. Its recommendation algorithm is responsible for 70% of all video views on the platform, meaning most users watch what the algorithm suggests rather than what they search for.

Internal research at StreamView, conducted by the company's own data science team, finds that the recommendation algorithm is driving a measurable increase in viewer radicalization. Users who watch mainstream political commentary are steadily recommended more extreme content. The research shows that users who start with moderate news videos are, on average, recommended increasingly partisan content over a six-week period. The study also finds that this pattern increases watch time by 20%, which directly increases advertising revenue.

StreamView's Head of Product, David Chen, argues that changing the algorithm would cost the company an estimated $400 million annually in lost engagement. He says the research is preliminary and that users are free to watch whatever they choose. StreamView's Chief Ethics Officer, Maria Santos, argues that the company has a moral obligation to act on its own research, even at a financial cost. She proposes modifying the algorithm to reduce radicalization recommendations, even though it would lower engagement metrics.
...
1. Apply utilitarian reasoning to this scenario. Who benefits from keeping the current algorithm, and who is harmed? What would a utilitarian recommendation look like, and what information would you need to make that calculation?
...
Social media does not exist in a vacuum. What you post, share, and like can follow you into job interviews, courtrooms, and personal relationships. This section examines two areas where social media activity creates significant ethical and legal consequences: employer screening and online harassment.

### Social Media Screening in Hiring

Many employers review candidates' social media profiles as part of the hiring process. A 2023 survey by the Harris Poll found that a majority of hiring managers check applicants' social media accounts. Some companies use third-party services that compile social media activity into background reports.

From the employer's perspective, social media screening provides useful information. A candidate's public posts might reveal poor judgment, discriminatory attitudes, or behavior that conflicts with company values. Employers have a legitimate interest in avoiding hires who could create legal liability or workplace conflicts.
...
Second, social media screening can introduce illegal discrimination into the hiring process. When a manager views a candidate's profile, they may see information that cannot legally be used in hiring decisions: race, religion, age, disability status, pregnancy, and political affiliation. Even if the manager does not consciously use this information, research on implicit bias suggests it can influence decisions.
...
The scale of the problem is significant. Cyberabuse disproportionately affects women, people of color, and LGBTQ+ individuals. The effects are not limited to emotional distress. Victims report lost employment, damaged reputations, physical safety fears, and lasting psychological harm.
...
2. An employer rejects a candidate after discovering through a social media search that the candidate is pregnant. The employer claims the rejection was based on a negative post the candidate made about a previous employer. Analyze the ethical issues in this scenario, considering both the employer's and the candidate's perspectives. *(Analyze)*

3. A social media platform argues that it cannot be responsible for harassment because individual users create the harmful content. Evaluate this argument using any ethical framework from Module 1. *(Apply)*
...
The recommendation algorithms discussed in Section 4.2 deserve a closer look through the lens of **autonomy**, which is the ability to make your own informed decisions. Ethical reasoning, whether utilitarian, deontological, or based in social contract theory, generally assumes that people are making choices freely. But how free are your choices when an AI system is selecting what information you see?

Consider this: if a recommendation algorithm consistently shows you content supporting one political candidate and suppresses content about the other, your voting decision is being influenced by a system you did not choose and cannot see. You might believe you formed your opinion independently, but the algorithm shaped the information environment you used to form it.
...
3. A social media company introduces a "time limit" feature that reminds users to take a break after one hour. Critics say the feature is buried in settings, turned off by default, and easy to dismiss. Apply utilitarian reasoning to evaluate whether this feature represents a genuine ethical effort or a token gesture. *(Apply)*

---

## 4.5 Skills Lab 4A - Social Media Ethics Audit

**Goal:** Analyze a realistic social media ethics scenario from multiple stakeholder perspectives, apply ethical frameworks, and develop a set of recommendations that balance competing interests.

**Estimated time:** 90-120 minutes

### Scenario: The HealthyLife App Controversy
...
* The platform has partnered with supplement companies that pay for "native advertising," meaning their paid promotions appear as regular user posts without clear labels. Some of these supplements make unverified health claims. HealthyLife receives 35% of its revenue from these partnerships.
...
1. Identify all stakeholders in this scenario. For each stakeholder, describe their specific interest and what they stand to gain or lose. Include at least five distinct stakeholder groups.
...
3. Explain how informed consent does or does not apply to this scenario. Consider whether users understood how the algorithm would shape their experience when they signed up.

### Part 2: Application (Aligns with LO2)

4. Apply **utilitarianism** to this scenario. Identify who benefits and who is harmed by HealthyLife's current practices. What recommendation does a utilitarian analysis produce?
5. Apply **deontology** to this scenario. What duties does HealthyLife owe to its users? Does the platform's knowledge of algorithmic harm change its ethical obligations? Reference Kant's categorical imperative in your analysis.
6. Apply **social contract theory** to this scenario. Using the veil of ignorance, what rules would people agree to for a platform like HealthyLife if they did not know whether they would be a company executive, an advertiser, an adult user, or a vulnerable teenager?
...
|---|---|---|---|---|---|
| **Stakeholder identification** | Identifies all major stakeholders with specific, accurate descriptions of their interests and what they stand to gain or lose | Identifies most stakeholders with reasonable descriptions of their interests | Identifies some stakeholders but descriptions lack specificity or miss important interests | Lists stakeholders without meaningful description of their interests | Missing or inaccurate |
| **Framework application** | Applies three frameworks accurately with clear reasoning and specific references to the scenario details | Applies frameworks correctly with adequate reasoning and some scenario references | Applies frameworks but with gaps in reasoning or limited connection to the specific scenario | Attempts to apply frameworks but with significant errors or confusion between them | Missing or not recognizable as framework application |
| **Recommendation quality** | Recommendations are specific, actionable, and well-supported by multiple frameworks with explicit reasoning for each | Recommendations are clear and supported by at least one framework each | Recommendations are present but vague or weakly connected to ethical frameworks | Recommendations are generic or unsupported by ethical reasoning | No recommendations provided |
| **Critical reasoning** | Demonstrates sophisticated analysis that acknowledges complexity, considers counterarguments, and avoids oversimplification | Shows solid critical thinking with some acknowledgment of competing perspectives | Shows basic reasoning but tends toward oversimplification or one-sided analysis | Reasoning is superficial or relies on unsupported assertions | No critical reasoning demonstrated |
| **Writing and professionalism** | Writing is clear, organized, and uses ethical terminology accurately throughout; well-structured with clear headings | Writing is clear with mostly accurate terminology and reasonable organization | Writing is understandable but disorganized or imprecise in ethical terminology | Writing is unclear or contains frequent errors in terminology and organization | Unreadable or off-topic |
...
* **Algorithmic bias:** Systematic errors or unfair outcomes in automated systems caused by biased training data, flawed design, or optimization for metrics that produce inequitable results.
...
3. A social media platform discovers that its recommendation algorithm promotes content linked to self-harm among teenage users. Using two ethical frameworks from Module 1, explain what the platform should do and why.
...
* Reference at least one ethical framework or concept from this module or previous modules
...
* **Electronic Frontier Foundation (EFF): "Social Media and Your Rights."** A comprehensive overview of user rights, platform policies, and current legal battles over social media regulation. Free at eff.org.

* **Pew Research Center: "Americans and Privacy."** Ongoing research tracking public attitudes toward data collection, privacy, and social media. Free reports available at pewresearch.org.

* **Zuboff, S. (2019). *The Age of Surveillance Capitalism.*** Examines how tech companies extract and monetize personal data. Chapters 1-3 provide a readable introduction to the attention economy concepts discussed in this module.

* **Maréchal, N. and Biddle, E.R. (2020). "It's Not Just the Content, It's the Business Model."** A report from Ranking Digital Rights exploring how platform business models, not just individual content decisions, create ethical problems. Free at rankingdigitalrights.org.

* **Reynolds, G. (2024). *Ethics in Information Technology* (7th ed.).** Chapter on social networking covers additional case studies and legal developments related to this module's topics. Available through the college bookstore.

---

## Looking Ahead ⏩

In Module 5, you will shift your focus from the ethical responsibilities of platforms to the ethical responsibilities of individuals within organizations. When you discover that your employer is doing something wrong, what are your options? Module 5 examines whistleblowing, the legal protections available to those who report wrongdoing, and the fiduciary responsibilities organizations have when they hold private information. You will apply the frameworks from this module to scenarios where personal conscience and professional loyalty come into direct conflict.
