...
Both the ACM and IEEE have issued statements specifically addressing AI ethics. The ACM's Statement on Algorithmic Transparency and Accountability (2017) calls for computing professionals to ensure that algorithmic systems are transparent, explainable, and subject to meaningful oversight. IEEE's Ethically Aligned Design initiative provides a detailed framework for integrating ethical considerations into the design of autonomous and intelligent systems.

Beyond these organizational statements, a growing consensus identifies several obligations specific to IT professionals who work with AI:

* **Transparency.** When you build or deploy AI systems, the people affected by those systems have a right to know that AI is being used and to understand, in general terms, how it works. In Module 8, you learned about the EU AI Act's requirements for transparency in high-risk AI systems. Professional ethics goes further than legal compliance: even where transparency is not legally required, it may be ethically necessary.
* **Bias testing and fairness.** You learned in Module 3 that algorithmic bias often enters AI systems through training data that reflects historical inequities. IT professionals have an obligation to test their systems for disparate impact and to address bias proactively, not just when regulators or the public demand it.
* **Human oversight.** For consequential decisions (hiring, lending, medical treatment, criminal justice), professional ethics requires that humans remain in the decision loop. AI can inform decisions, but removing human judgment from high-stakes outcomes raises serious ethical concerns.
* **Accountability and documentation.** When an AI system causes harm, there must be a way to trace what happened and why. This requires thorough documentation of training data, model architecture, testing results, and deployment conditions. In Module 11, you learned about incident response; AI systems need comparable accountability structures.
...
* **IEEE Ethically Aligned Design (First Edition, 2019).** A comprehensive framework for embedding ethical considerations into the design of autonomous and intelligent systems. Published by IEEE and available as a free download.
