...
* **10.1-LO1 (Analyze):** Classify forms of online speech as protected expression, hate speech, or defamation by applying legal and ethical criteria (CLO XII)
* **10.2-LO2 (Evaluate):** Evaluate the ethical implications of employee monitoring practices by weighing employer interests against employee privacy rights (CLO XIII)
* **10.3-LO3 (Evaluate):** Assess the role of AI in content moderation and workplace surveillance, including the accuracy and bias challenges these systems introduce (CLO XII, CLO XIII)
